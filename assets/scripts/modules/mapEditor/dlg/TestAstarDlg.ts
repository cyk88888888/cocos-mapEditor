...
import { PathQuadSeek } from '../../road/PathQuadSeek';
...
export class TestAstarDlg extends UIDlg {
    ...
    protected onEnter(): void {
        let self = this;
        //起点测试坐标
        self.input_startX.string = "840";
        self.input_startY.string = "210";
        self.input_endX.string = "390";
        self.input_endY.string = "345";
    }
    ...
    private _tap_btn_ok() {
        ...
        let radius = Number(self.input_radius.string || 0);
        // PathFindingAgent.inst.setPathQuadSeek(PathQuadSeek.path_dire_4);
