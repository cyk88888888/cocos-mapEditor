    ...
    private onDragMapThingDown(data: G.DragMapthingInfo) {
        ...
        if(isBelve){
            if(isByDrag){
                ...
                let cellWidth = self.mapMgr.cellWidth;
                let cellHeight = self.mapMgr.cellHeight;
                let pointArr = [
                    [grid.col * cellWidth, grid.row * cellHeight],
                    [grid.col * cellWidth + cellWidth, grid.row * cellHeight],
                    [grid.col * cellWidth + cellWidth, grid.row * cellHeight + cellHeight],
                    [grid.col * cellWidth, grid.row * cellHeight + cellHeight],
                ];
